...
def main() -> None:
    ...
    parser.add_argument(
        "--mode",
        choices=("all", "delivery", "execution"),
        default="all",
        help="Run all handlers or isolate Provider delivery from Agent execution.",
    )
...
async def run_worker(
    *,
    ...
    mode: Literal["all", "delivery", "execution"] = "all",
) -> None:
